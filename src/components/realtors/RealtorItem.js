...
import ReltorContext from '../../context/realtor/realtorContext'



const RealtorItem = (props) => {
    
    const { realtor } = props
    const realtorContext = useContext(ReltorContext)
    const { getRealtor } =  realtorContext
