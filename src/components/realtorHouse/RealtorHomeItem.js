  ...
  return (
    <div className="add__card">
      <div className="home__side home__side--front">
        <img
          src={home.houseImages[0].url}
          alt="gal-1"
          className="home__img realtor__img"
        />
        ...
        <button className="btn home__btn"></button>
      </div>

      <div className="home__side home__side--back home__side--back-1">
        <button onClick={() => setModalOpen(true)} className="btn home__btn">
          {" "}
          Delete
        </button>
        <button onClick={() => setCurrent(home)} className="btn home__btn">
          {" "}
          Edit
        </button>
      </div>
