...
const AddForm = () => {
  ...
  const { current, addHouse, removeImage, clearCurrent, updateHouse } =
    houseContext;
      ...
      <div className="add-home">
        <div className="add__form">
          <form className="form" onSubmit={onSubmitHandler}>
            ...
            <div className=" form__input--grid-2">
              ...
              <div className="form__input--col-1">
                <input
                  ...
                  required
                />
                <label htmlFor="garage" className="form__label">
                  Garage
                </label>
              </div>
            </div>
            ...
            <input
              type="submit"
              value={current ? "Update House" : "Add House"}
              name="submit"
              className="btn btn--green"
            />

            {current && (
              <button onClick={clearAll} className="btn home__btn">
                {" "}
                Clear
              </button>
            )}
